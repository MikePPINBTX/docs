...
related: [troubleshooting-mobile, troubleshooting-web-admin, troubleshooting-sync-and-offline]
status: stable
...
**Fix:** Go to **Settings → Pricing Manager** and create at least one pricing rule for your primary service. See the [Pricing Manager guide](/1nspect/features/pricing-manager) for setup instructions.
...
For billing or account-level issues, email **support@mymavtech.com** directly.
